export default async function HomePage() {
  return (
    <div className="w-full padding-responsive flex flex-col items-center">
      <h1 className="text-center h1-responsive font-bold text-title m-12 title-shadow">
        OnPar
      </h1>
      <div className="mx-auto w-[80%] max-w-md border-[5px] rounded bg-text border-color min-h-[30vh] flex items-center">
